...
-- editor on 2026-09-18 16:03. Ground truth for component placement on the
-- standard buggy branch. This is the corrected export: it defines all eight
-- spike mounts, the last two being an extra row at (+/-25, 20) between the front
-- and mid pairs -- not outboard, which is where an earlier guess put them.
return {
