-- The user's first fully-upgraded buggy export (2026-09-18 15:23), which
-- predates the Heavy Anchor Array mounts. Kept as the migration test case:
-- a saved layout that defines six mounts and must be brought up to eight.
-- See buggy_fully_upgraded.lua for the current verified layout.
return {
