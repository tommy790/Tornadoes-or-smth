...
TIV.Config.SpikeOffsets = {
    jeep = {
        ...
        { pos = Vector(-25,   50, 0), ang = Angle(-80, 0, 0), name = "Front Left",  group = "front" },
        { pos = Vector( 30,  -20, 0), ang = Angle( 80, 0, 0), name = "Mid Right",   group = "mid"   },
        { pos = Vector(-30,  -20, 0), ang = Angle(-80, 0, 0), name = "Mid Left",    group = "mid"   },
        { pos = Vector( 20, -100, 0), ang = Angle( 80, 0, 0), name = "Rear Right",  group = "rear"  },
        { pos = Vector(-20, -100, 0), ang = Angle(-80, 0, 0), name = "Rear Left",   group = "rear"  },
    },
    jalopy = {
        { pos = Vector( 25,   45, 0), ang = Angle( 80, 0, 0), name = "Front Right", group = "front" },
        { pos = Vector(-25,   45, 0), ang = Angle(-80, 0, 0), name = "Front Left",  group = "front" },
        { pos = Vector( 25,    0, 0), ang = Angle( 80, 0, 0), name = "Mid Right",   group = "mid"   },
        { pos = Vector(-25,    0, 0), ang = Angle(-80, 0, 0), name = "Mid Left",    group = "mid"   },
        { pos = Vector( 25, -100, 0), ang = Angle( 80, 0, 0), name = "Rear Right",  group = "rear"  },
        { pos = Vector(-25, -100, 0), ang = Angle(-80, 0, 0), name = "Rear Left",   group = "rear"  },
    },
    prop_vehicle_apc = {
        { pos = Vector( 35,   90, 0), ang = Angle( 80, 0, 0), name = "Front Right", group = "front" },
        { pos = Vector(-35,   90, 0), ang = Angle(-80, 0, 0), name = "Front Left",  group = "front" },
        { pos = Vector( 35,   10, 0), ang = Angle( 80, 0, 0), name = "Mid Right",   group = "mid"   },
        { pos = Vector(-35,   10, 0), ang = Angle(-80, 0, 0), name = "Mid Left",    group = "mid"   },
        { pos = Vector( 35, -110, 0), ang = Angle( 80, 0, 0), name = "Rear Right",  group = "rear"  },
        { pos = Vector(-35, -110, 0), ang = Angle(-80, 0, 0), name = "Rear Left",   group = "rear"  },
    },
}
