...
function TIV.Editor3D.Open()
    ...
    local function RefreshEditor()
        ...
        metaPanel:SetTall(96)
        metaPanel.Paint = function(s, w, h)
            draw.RoundedBox(4, 0, 0, w, h, Color(16, 20, 28, 200))
            draw.SimpleText("Component Name", "DermaDefault", 8, 8, Color(180, 190, 210), TEXT_ALIGN_LEFT)
            draw.SimpleText("Model / Prop Path", "DermaDefault", 8, 48, Color(180, 190, 210), TEXT_ALIGN_LEFT)
        end

        local nameEntry = vgui.Create("DTextEntry", metaPanel)
        nameEntry:SetPos(120, 6)
        nameEntry:SetSize(metaPanel:GetWide() - 130, 24)
        ...
        modelEntry:SetPos(120, 46)
        modelEntry:SetSize(metaPanel:GetWide() - 130, 24)
        ...
        curatedCombo:SetPos(120, 72)
        curatedCombo:SetSize(metaPanel:GetWide() - 130, 20)
