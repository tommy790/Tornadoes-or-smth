...
ENT.Spawnable = false 
ENT.AdminOnly = "false" 
ENT.PrintName = "Firewhirl" 

function ENT:Initialize()
    if SERVER then
    
    self.Force = math.random(80, 140)    
    ...
    print("This firewhirl's windspeed is " .. self.Force )
	print("This firewhirl is an equivalent to an EF" .. self.sFScale )
    self:startx()
